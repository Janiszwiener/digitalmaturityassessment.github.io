...
?>
	...
	<div class="col-xl-9 col-lg-11 m-2 pb-4 rounded text-center text-light mx-auto">
			...
			<section class="jumbotron text-center bg-dark border-primary border">
				<div class="container">
					<h1 class="jumbotron-heading">Improve Your Digital Capabilities</h1>
					<p class="lead">This online Digital Maturity Assessment questionnaire will help you understand your current strengths and weaknesses and then recommend resources that can support you in taking the next steps on your Digital journey.</p>
					<p>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<p class="text-justify">Our set of carefully designed questions across 4 different areas will help you quickly establish your current level of Digital maturity.</p>
				...
				<div class="col-lg-4">
					...
					<p class="text-justify">For each area we have identified a range of free or commercially available books, videos, blog posts, white papers and websites that will help you take the next steps on your Digital journey.</p>
				</div><!-- /.col-lg-4 -->
			...
			<section class="jumbotron text-center border border-primary bg-dark mt-2">
				<div class="container">
					...
					<p class="lead">This tool was created by ATOS DTC Spain and is a dublication of a Digital-Maturity assessment tool created by members of the Atos Expert Community with contributions from many other practitioners across Atos and Worldline globally. You can find out more about this core team below.	</p>
				</div>
			</section>
