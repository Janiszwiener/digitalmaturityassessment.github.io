...
<html lang="en">
	<head>
		...
		<!-- Open Graph info -->
		<meta property="og:title" content="Digital Maturity Assessment" />
		<meta property="og:description" content="This online Digital Maturity Assessment questionnaire will help you understand your current strengths and weaknesses and then recommend resources that can support you in taking the next steps on your dgital journey." />
		<meta property="og:site_name" content="Digital Maturity Assessment" />
	...
	<nav class="navbar navbar-dark bg-primary fixed-top navbar-expand-md form-group" ">
		<a href="about" class="navbar-brand">Digital Maturity Assessment</a>
